...
function restartFadeInAnimation() {
    ...
    const textElements = activeSlide.querySelectorAll('.fade-in');

    textElements.forEach(element => {
        element.classList.remove('fade-in'); // إزالة الكلاس
        void element.offsetWidth; // إعادة تدفق الصفحة لإعادة التشغيل
        element.classList.add('fade-in'); // إعادة إضافة الكلاس
    });
}
